...
*/
// TestRTML31Create.java
// $Header: /space/home/eng/cjm/cvs/org_estar_rtml/test/TestRTML31Create.java,v 1.1 2008-05-13 16:56:06 cjm Exp $
 ...
 * Use:
 * <code>
 * java org.estar.rtml.test.TestRTML31Create -help
 * </code>
...
public class TestRTML31Create
{
	 ...
	 */
	protected RTML31Create create = null;
	/**
	 ...
	 * Leaving as null causes RTML31Create to use the default.
	 */
	...
	public void parseArguments(String args[]) throws RTMLException,Exception
	{
		...
		for(int i = 0; i < args.length; i++)
		{
			...
			{
				document.setMode("observation");// this means the document has been completed.
			}
	...
	public void help()
	{
		System.err.println("java -Dhttp.proxyHost=wwwcache.livjm.ac.uk -Dhttp.proxyPort=8080 org.estar.rtml.test.TestRTML31Create");
		...
		System.err.println("\t[-iahost <hostname>][-iaid <id>][-iaport <number>][-iauri <uri>][-help]");
	...
	{
		TestRTML31Create testCreate = null;

		try
		{
			testCreate = new TestRTML31Create();
			testCreate.parseArguments(args);
			testCreate.run();
		}
		catch(Exception e)
		{
			System.err.println("TestRTML31Create:main:"+e);
			e.printStackTrace();
			System.exit(1);
		}
		System.exit(0);
